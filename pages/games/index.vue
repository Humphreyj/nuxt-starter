...
const { data } = await useFetch('/api/games/getGames')
const gamesList = ref(data.value.games || [])
</script>

<template>
  <div
    class="h-full w-full md:w-1/3 mx-auto flex flex-col items-start justify-start"
  >
